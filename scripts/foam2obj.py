...
if __name__ == "__main__":
    print("[foam2obj] Starting foam2obj --------------------------")
    ...
    if args.i is None or not os.path.isdir(args.i):
        print("[foam2obj] invalid input directory")
        exit(-1)
    ...
    if args.p is not None:
        ...
        if os.path.isfile(output_obj):
            print("[foam2obj] output file already exists")
            exit(1)

        print("[foam2obj] input:  ", str(args.i))
        print("[foam2obj] output: ", str(output_obj))
        print("[foam2obj] patch:  ", args.p)
